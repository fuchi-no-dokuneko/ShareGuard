...
| Provider snapshot, Import Anchor, timer and transient cleanup | `core/session`, `core/security` | malformed/polyglot/bounds, snapshot mismatch, cancellation, reboot/clock and canary tests |
